...
@ModelEntity
@ImplementationClass(GinaNotifyMethodEventDescription.GinaNotifyMethodEventDescriptionImpl.class)
@XMLElement(xmlTag = "GinaNotifyMethodEvent")
public abstract interface GinaNotifyMethodEventDescription extends
		EventDescription {
	...
	@Initializer
	public GinaNotifyMethodEventDescription init(
	...
	public abstract class GinaNotifyMethodEventDescriptionImpl implements
			GinaNotifyMethodEventDescription {
