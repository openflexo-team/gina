...
/**
 * This strategy will record all the available events, sorted by origin.
 * 
 * @author Alexandre
 *
 */
public class StandardRecordingStrategy extends RecordingStrategy {
	public StandardRecordingStrategy(GinaReplaySession session) {
		super(session);
	}
