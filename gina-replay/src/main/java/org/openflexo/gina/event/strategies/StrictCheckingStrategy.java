...
/**
 * 
 * This class implements the following checking strategy :
...
public class StrictCheckingStrategy extends CheckingStrategy {
	...
	public void checkSystemEvents(InteractionCycle node) throws InvalidRecorderStateException {
		...
		List<GinaEvent> listReplayed = new LinkedList<GinaEvent>();
		List<GinaEvent> listExcepted = new LinkedList<GinaEvent>();
