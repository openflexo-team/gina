...
/**
 * Represents a widget able to select a {@link Date}<br>
 ...
 * @author sylvain
 */
public interface FIBDateWidget<C> extends FIBWidgetView<FIBDate, C, Date> {
	 ...
	 * @param <C>
	 */
	public static interface DateWidgetRenderingAdapter<C> extends RenderingAdapter<C> {

		public Date getSelectedDate(C component);
