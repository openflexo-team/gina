...
/**
 * Represents a widget able to edit a number
 * 
 * @param <C>
...
public interface FIBNumberWidget<C, T extends Number> extends FIBWidgetView<FIBNumber, C, T> {
	...
	public static interface NumberWidgetRenderingAdapter<C, T extends Number> extends RenderingAdapter<C> {
		...
		public void setNumber(C component, T aNumber);
		...
		public boolean isWidgetEnabled(C component);

		public void setWidgetEnabled(C component, boolean enabled);
