 ...
 * @author sylvain
 */
public class JSplitLayout extends FIBLayoutManagerImpl<JXMultiSplitPane, JComponent, SplitLayoutConstraints> {

	public JSplitLayout(JFIBSplitPanelView panelView) {
		super(panelView);
	}
	...
	@Override
	public void setLayoutManager(JXMultiSplitPane container) {
