...
import org.openflexo.fib.swing.utils.BindingSelector.EditionMode;
import org.openflexo.fib.swing.utils.table.AbstractModel;
import org.openflexo.fib.swing.utils.table.BindingValueColumn;
import org.openflexo.fib.swing.utils.table.IconColumn;
import org.openflexo.fib.swing.utils.table.StringColumn;
import org.openflexo.fib.swing.utils.table.TabularPanel;
			...
			if (bdable != null) {
				...
				if (bf != null) {
					...
					if (bindingSelector.editionMode == EditionMode.COMPOUND_BINDING) {
						...
						_accessibleProperties.addAll(bindingSelector.getBindable().getBindingFactory()
								.getAccessibleFunctionPathElements(_element));
