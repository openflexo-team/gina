 ...
 * 
 */
public class JFIBReferencedComponentWidget extends FIBWidgetView<FIBReferencedComponent, JComponent, Object> /* implements
BindingEvaluationContext*/{
	...
	public JFIBReferencedComponentWidget(FIBReferencedComponent model, FIBController controller, FIBViewFactory factory) {
