...
interface Actions {
	...
	class AboutAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			AboutDialog ad = new AboutDialog((JavaDemoApp) SwingUtilities.getWindowAncestor(demo));
	...
	/**
	 * Changes the language being edited and installs appropriate language support.
	 */
	class StyleAction extends AbstractAction {
		...
		StyleAction(DemoRootPane demo, String name, String res, String style) {
			putValue(NAME, name);
			this.demo = demo;
			this.res = res;
			this.style = style;
