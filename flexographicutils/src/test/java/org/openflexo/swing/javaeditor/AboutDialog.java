...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(JavaDemoApp parent) {
	...
	/**
	 * Used by makeSpringCompactGrid. This is ripped off directly from <code>SpringUtilities.java</code> in the Sun Java Tutorial.
	 *
	 * @param parent
	 *            The container whose layout must be an instance of <code>SpringLayout</code>.
	 * @return The spring constraints for the specified component contained in <code>parent</code>.
	 */
	...
	/**
	 * This method is ripped off from <code>SpringUtilities.java</code> found on Sun's Java Tutorial pages. It takes a component whose
	 * layout is <code>SpringLayout</code> and organizes the components it contains into a nice grid. Aligns the first <code>rows</code> *
	 * <code>cols</code> components of <code>parent</code> in a grid. Each component in a column is as wide as the maximum preferred width
	 * of the components in that column; height is similarly determined for each row. The parent is made just big enough to fit them all.
	 *
	 * @param parent
