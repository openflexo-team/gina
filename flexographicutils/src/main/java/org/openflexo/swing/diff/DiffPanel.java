...
public class DiffPanel extends JLayeredPane {
	...
	public DiffPanel(DiffReport diffReport, TokenMarkerStyle style, String leftLabel, String rightLabel, String noChangeLabel,
			boolean _isLeftOriented) {
		this(diffReport, style, leftLabel, rightLabel, noChangeLabel, _isLeftOriented, BorderLayout.NORTH);
	}

	public DiffPanel(DiffReport diffReport, TokenMarkerStyle style, String leftLabel, String rightLabel, String noChangeLabel,
			boolean _isLeftOriented, String changesListOrientation) {
		super();
		_report = diffReport;
	...
	private class SelectChange implements ActionListener {
		...
		SelectChange(DiffChange change) {
			this.change = change;
		}

		@Override
		public void actionPerformed(ActionEvent e) {
			selectChange(change, false);
		}
	}
