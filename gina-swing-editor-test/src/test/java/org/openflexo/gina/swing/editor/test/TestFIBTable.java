...
public class TestFIBTable extends GinaSwingEditorTestCase {
	...
	public void testComponent()
		...
		final UserList userList = new UserList(user1, user2, user3, user4);
		instanciateFIBEdition("TestTable2", ResourceLocator.locateSourceCodeResource("TestFIB/TestTable2.fib"), userList);
	}
