...
public class JFIBEditableSpacerWidget extends JFIBSpacerWidget implements FIBSwingEditableView<FIBSpacer, JComponent> {

	@SuppressWarnings("unused")
	private static final Logger logger = FlexoLogger.getLogger(JFIBEditableSpacerWidget.class.getPackage().getName());

	private final FIBSwingEditableViewDelegate<FIBSpacer, JComponent> delegate;
	...
	public JFIBEditableSpacerWidget(FIBSpacer model, FIBEditorController editorController) {
	...
	@Override
	public FIBSwingEditableViewDelegate<FIBSpacer, JComponent> getDelegate() {
		return delegate;
	}
