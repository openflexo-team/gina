...
public class IssueFixing<R extends ValidationRule<R, V>, V extends Validable> extends PropertyChangedSupportDefaultImplementation {
	...
	private FIBValidationModel validationModel;
	private FIBEditorController editorController;

	public IssueFixing(ProblemIssue<R, V> issue, FIBEditorController editorController) {
		super();
		this.issue = issue;
		this.editorController = editorController;
		validationModel = editorController.getValidationModel();
	}
