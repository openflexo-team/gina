...
public class MoveToTop extends AbstractEditorActionImpl {

	public MoveToTop(FIBEditorController anEditorController) {
		super("to_top", FIBEditorIconLibrary.TOP_ICON, anEditorController);
	}
	...
	public FIBModelObject performAction(FIBModelObject object) {
		...
		((FIBComponent) object).getParent().componentFirst((FIBComponent) object);
		return object;
	}
