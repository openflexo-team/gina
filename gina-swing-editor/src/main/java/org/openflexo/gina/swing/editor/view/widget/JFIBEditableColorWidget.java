...
public class JFIBEditableColorWidget extends JFIBColorWidget implements FIBSwingEditableView<FIBColor, ColorSelectorPanel> {

	@SuppressWarnings("unused")
	private static final Logger logger = FlexoLogger.getLogger(JFIBEditableColorWidget.class.getPackage().getName());

	private final FIBSwingEditableViewDelegate<FIBColor, ColorSelectorPanel> delegate;
	...
	public JFIBEditableColorWidget(FIBColor model, FIBEditorController editorController) {
	...
	@Override
	public FIBSwingEditableViewDelegate<FIBColor, ColorSelectorPanel> getDelegate() {
		return delegate;
	}
