...
public class DefaultEditorAction extends AbstractEditorActionImpl {
	...
	public DefaultEditorAction(String actionName, Icon actionIcon, ActionPerformer performer, ActionAvailability availability,
			FIBEditorController anEditorController) {
		super(actionName, actionIcon, anEditorController);
	...
	public FIBModelObject performAction(FIBModelObject object) {
		if (getPerformer() != null) {
			return getPerformer().performAction(object);
		}
		return null;
	}
	...
	public boolean isVisibleFor(FIBModelObject object) {
		if (getAvailability() != null) {
			return getAvailability().isAvailableFor(object);
		}
		return false;
	}
