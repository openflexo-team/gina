...
public class MoveUp extends AbstractEditorActionImpl {

	public MoveUp(FIBEditorController anEditorController) {
		super("up", FIBEditorIconLibrary.UP_ICON, anEditorController);
	}
	...
	public FIBModelObject performAction(FIBModelObject object) {
		...
		((FIBComponent) object).getParent().componentUp((FIBComponent) object);
		return object;
	}
