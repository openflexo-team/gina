...
public class JFIBEditableDateWidget extends JFIBDateWidget implements FIBSwingEditableView<FIBDate, DateSelectorPanel> {

	@SuppressWarnings("unused")
	private static final Logger logger = FlexoLogger.getLogger(JFIBEditableDateWidget.class.getPackage().getName());

	private final FIBSwingEditableViewDelegate<FIBDate, DateSelectorPanel> delegate;
	...
	public JFIBEditableDateWidget(FIBDate model, FIBEditorController editorController) {
	...
	@Override
	public FIBSwingEditableViewDelegate<FIBDate, DateSelectorPanel> getDelegate() {
		return delegate;
	}
