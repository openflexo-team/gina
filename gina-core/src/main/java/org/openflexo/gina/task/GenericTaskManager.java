...
/**
 * A {@link GenericTaskManager} controls and monitors the execution of some {@link FlexoTask} where some dependancies between tasks might be
 * declared.<br>
 * The implementation of a {@link GenericTaskManager} may vary and can be either multithreaded or monothreaded
 * 
 * @author sylvain
 *
 */
public interface GenericTaskManager<T extends GinaTask> extends HasPropertyChangeSupport {
	 ...
	 * @param tasks
	 */
	public abstract void scheduleExecution(T... tasks);
	 ...
	 * @return
	 */
	public List<T> getScheduledTasks();
