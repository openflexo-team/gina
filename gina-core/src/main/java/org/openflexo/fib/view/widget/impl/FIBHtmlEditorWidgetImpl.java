 ...
 * @author sylvain
 */
public abstract class FIBHtmlEditorWidgetImpl<C> extends FIBWidgetViewImpl<FIBHtmlEditor, C, String>implements FIBHtmlEditorWidget<C> {

	private static final Logger LOGGER = Logger.getLogger(FIBHtmlEditorWidgetImpl.class.getPackage().getName());
