 ...
 * @author sguerin
 */
public class FIBResourceWidget extends FIBWidgetView<FIBFile, JTextField, File> {

	static final Logger logger = Logger.getLogger(FIBResourceWidget.class.getPackage().getName());
	...
	public FIBResourceWidget(FIBFile model, FIBController controller) {
